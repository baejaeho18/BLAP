package com.blap.blapweb.Interceptor;
...
public class LoginInterceptor extends HandlerInterceptorAdapter{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		Object obj = session.getAttribute("kakaoemail");
		
		if(obj == null) {
			//로그인이 안되어 있는 상태임으로 로그임 페이지로 다시 돌려보냄
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse reponse, Object handler, ModelAndView modelAndView) throws Exception {
		super.postHandle(request, reponse, handler, modelAndView);
	}
}
